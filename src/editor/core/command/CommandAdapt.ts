...
import { AREA_CONTEXT_ATTR, EDITOR_ELEMENT_STYLE_ATTR, EDITOR_ROW_ATTR, LIST_CONTEXT_ATTR, TABLE_CONTEXT_ATTR } from '../../dataset/constant/Element'
import { titleOrderNumberMapping, titleSizeMapping } from '../../dataset/constant/Title'
...
import { IAppendElementListOption, IDrawImagePayload, IDrawOption, IForceUpdateOption, IGetImageOption, IGetValueOption, IPainterOption } from '../../interface/Draw'
...
import { IDeleteElementByIdOption, IElement, IElementPosition, IElementStyle, IGetElementByIdOption, IInsertElementListOption, IUpdateElementByIdOption } from '../../interface/Element'
import { ICopyOption, IPasteOption, IPositionContextByEventOption, IPositionContextByEventResult, ITableInfoByEvent } from '../../interface/Event'
...
import { IReplaceOption, ISearchOption, ISearchResultContext } from '../../interface/Search'
import { ITextDecoration } from '../../interface/Text'
import { IGetTitleValueOption, IGetTitleValueResult } from '../../interface/Title'
import { IWatermark } from '../../interface/Watermark'
import { cloneProperty, deepClone, downloadFile, getUUID, isNumber, isObjectEqual } from '../../utils'
import { createDomFromElementList, formatElementContext, formatElementList, getAnchorElement, getElementListByHTML, getTextFromElementList, isTextLikeElement, pickElementAttr, zipElementList } from '../../utils/element'
...
export class CommandAdapt {
    ...
    public async print() {
        ...
        const base64List = await this.draw.getDataURL({ pixelRatio: printPixelRatio, mode: EditorMode.PRINT })
        printImageBase64(base64List, { width: width, height: height, direction: paperDirection })
        if (scale !== 1) {
            this.draw.setPageScale(scale)
        }
    }

    public async getPrintData(): Promise<string[]> {
